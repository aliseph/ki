...
public class AdminController extends BaseController {
    ...
    public String List(Integer pageNum, String status, ModelMap model, Integer numPerPage) {
        ...
        if (numPerPage != null && numPerPage != 0) {
            pagingInfo.setNumPerPage(numPerPage);
        }
        if (pageNum != null) {
    ...
    public Map<String, Object> vali(String account) {
        if (adminService.validation(account)) {
            return DWZResponse.validateOK();
        } else {
            return DWZResponse.validateError();
        }
    }
    ...
    public Map<String, Object> delete(String id) {
        ...
        return DWZResponse.deleteOK(REL);
    }
    ...
    public Map<String, Object> recover(String id) {
        ...
        return DWZResponse.operateOK(SpringContextUtil.getMessage("response.recover.ok"), REL);
    }
    ...
    public Map<String, Object> resetPass(String id) {
        ...
        return DWZResponse.operateOK(SpringContextUtil.getMessage("response.reset.password.ok"), REL);
    }
    ...
    public Map<String, Object> add(@Valid Admin admin, Errors errors) {
        ...
        return DWZResponse.closeCurrent(REL);
    }
